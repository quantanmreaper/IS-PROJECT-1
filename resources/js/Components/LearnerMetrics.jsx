...
export default function LearnerMetrics({ metrics }) {
    ...
    const metricCards = [
        {
            ...
            value: metrics.total_courses_enrolled || 0,
            icon: (
                <svg
        ...
        },
        {
            ...
            value: metrics.total_sessions_booked || 0,
            icon: (
                <svg
                    className="w-8 h-8 text-blue-500"
                    fill="none"
        ...
        {
            title: "Course Reviews Written",
            value: metrics.total_reviews_written || 0,
            icon: (
                <svg
                    className="w-8 h-8 text-blue-500"
                    fill="none"
                    ...
                    >
                        <div className="p-6">
                            <div className="flex items-center mb-4">
                                <div
                                    className={`${card.accentColor} p-3 rounded-full mr-3`}
                                >
                                    {card.icon}
                                </div>
