                    ...
                    <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between">
                        <div>
                            ...
                            <p className="text-blue-100 text-lg mt-2 max-w-2xl">
                                Monitor and manage platform's key metrics and
                                performance.
                            </p>
                        </div>
                        ...
                        {isLoading ? (
                            ...
                            <div style={{ height: "400px" }}>
                                <Bar
                                    options={barOptions}
                                    data={{
                                        labels: chartData.monthlyUsers.map(
                                            (item) => item.month
                                        ),
                                        datasets: [
                                            {
                                                label: "Students",
                                                data: chartData.monthlyUsers.map(
                                                    (item) => item.count
                                                ),
                                                backgroundColor:
                                                    "rgba(59, 130, 246, 0.7)",
                                            ...
                                            {
                                                label: "Courses",
                                                data: chartData.monthlyCourses.map(
                                                    (item) => item.count
                                                ),
                                                backgroundColor:
                                                    "rgba(16, 185, 129, 0.7)",
                                            ...
                                            {
                                                label: "Sessions",
                                                data: chartData.monthlySessions.map(
                                                    (item) => item.count
                                                ),
                                                backgroundColor:
                                                    "rgba(245, 158, 11, 0.7)",
                        ...
                        <div className="p-6">
                            <div className="flex justify-center items-center">
                                <div className="max-w-md w-full">
                                    ...
                                    >
                                        <svg
                                            className="w-6 h-6 text-blue-600 mr-3 group-hover:scale-110 transition-transform duration-200"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
