...
export default function ViewCourse({ auth, course, isEnrolled }) {
    ...
    const handleEnroll = () => {
        ...
        setEnrolling(true);
        // Instead of direct payment, go to summary page (handled by backend Inertia render)
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        This course requires enrollment to view
                                ...
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <span className="bg-blue-100 text-blue-800 text-xs font-medium px-3 py-1 rounded-full">
                                        {activeLesson.content_type
                                            .charAt(0)
                                            .toUpperCase() +
                                            activeLesson.content_type.slice(1)}
                                    </span>
                                </div>
                            ...
                            {reviews.length > 0 ? (
                                ...
                                <div className="text-center py-12 border border-dashed border-gray-300 rounded-lg bg-blue-50">
                                    ...
                                    <p className="mt-1 text-sm text-gray-500 mb-4">
                                        {enrolled ? "Be the first to review this course!" : "Enroll in this course to leave a review."}
                                    </p>
                                    {enrolled && (
                                        <button
                                            onClick={() => setShowReviewForm(true)}
