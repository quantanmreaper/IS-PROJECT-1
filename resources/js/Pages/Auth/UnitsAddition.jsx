...
export default function UnitsAddition() {
   ...
   return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Add Unit</h2>}>
            <Head title="Add Unit" />
            <div className="py-12">
                    ...
                    <div className="bg-white p-6 shadow sm:rounded-lg">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="flex justify-end">
                                <PrimaryButton className="bg-green-600 hover:bg-green-800 focus:bg-green-700 active:bg-green-800 focus:ring-green-500" disabled={processing}>
                                    Add Unit
                                </PrimaryButton>
                            </div>
                        </form>
