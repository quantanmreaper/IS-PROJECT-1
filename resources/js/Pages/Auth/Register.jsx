            ...
            <div className="w-full max-w-lg bg-white/95 dark:bg-blue-900/90 rounded-3xl shadow-2xl p-8 sm:p-12 border-2 border-blue-200 dark:border-blue-800 relative overflow-hidden">
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="relative flex items-center gap-3 bg-blue-50 border border-blue-200 rounded-lg px-4 py-3 focus-within:ring-2 focus-within:ring-blue-300 focus-within:border-blue-400 transition">
                            ...
                            <input
                                ...
                                type="file"
                                accept="image/*,.pdf"
                                className="flex-1 bg-transparent border-0 focus:ring-0 focus:border-0 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200 transition"
                                onChange={(e) =>
