                    ...
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center shadow-lg">
                        ...
                        >
                            <path
                                ...
                                d="M12 2a7 7 0 017 7c0 2.386-1.053 4.09-2.25 5.25C15.053 15.09 15 16 15 17v1a3 3 0 01-6 0v-1c0-1-.053-1.91-1.75-2.75C6.053 13.09 5 11.386 5 9a7 7 0 017-7z"
                            />
                            <path
                                strokeLinecap="round"
                                strokeLinejoin="round"
                    ...
                    <div className="bg-white/90 p-8 shadow-2xl rounded-3xl border border-blue-100 relative overflow-hidden">
                        <div className="mb-8 text-center">
                            ...
                            <p className="text-gray-600">
                                Share your knowledge, inspire others, and grow
                                your skills. Fill in the details below to join
