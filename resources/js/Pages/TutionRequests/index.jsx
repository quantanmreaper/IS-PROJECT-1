    ...
    const columns = [
        {
            ...
            sortIcon: <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="flex space-x-2">
                    ...
                    <button
                        onClick={() => router.visit(route("chat.show", row.tutee.id))}
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-blue-600 text-sm font-medium">Manage and respond to student tution requests</p>
                        </div>
                        <div className="flex space-x-2">
                            <div className="bg-white shadow-sm rounded-lg px-4 py-2 flex items-center border border-blue-100">
                                ...
                                <div>
                                    ...
                                    <div className="font-semibold text-lg text-blue-800">{requests.length}</div>
                                </div>
                            </div>
                            <div className="bg-white shadow-sm rounded-lg px-4 py-2 flex items-center border border-blue-100">
                                ...
                                <div>
                                    ...
                                    <div className="font-semibold text-lg text-green-800">
                                        {requests.filter(r => r.accepted).length}
                                    </div>
                                </div>
                            </div>
                            <div className="bg-white shadow-sm rounded-lg px-4 py-2 flex items-center border border-blue-100">
                        ...
                        <DataTable
                            ...
                            noDataComponent={
                                <div className="text-gray-400 py-12 flex flex-col items-center">
                                    ...
                                    <p className="text-lg font-medium">No tution requests found</p>
