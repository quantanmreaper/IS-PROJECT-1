...
<head>
    ...
    <title>Welcome to Peer To Peer Mentorship!</title>
</head>
                        ...
                        <td style="padding:0 40px 24px;">
                            <p style="font-size:16px;color:#334155;margin:0 0 24px;line-height:1.5;">
                                Thank you for joining <span style="color:#0284c7;font-weight:600;">Peer To Peer Tutoring
                                    & Mentorship Platform</span> as a mentor.
                            </p>
                            <p style="font-size:16px;color:#334155;margin:0 0 24px;line-height:1.5;">
                                You can now start accepting mentorship requests, share your expertise, and help learners
                                grow in their academic and professional journeys.
                            </p>
                            <div
                                ...
                                <p style="font-size:15px;color:#0369a1;font-weight:500;margin:0;line-height:1.5;">
                                    ...
                                    - Complete your mentor profile<br>
                                    - Set your mentorship topics and availability<br>
                    ...
                    <tr>
                        <td
                            ...
                            <p style="font-size:14px;color:#64748b;margin:0 0 8px;line-height:1.5;">
                                Welcome aboard! We’re excited to have you as part of our mentor community.
                            </p>
